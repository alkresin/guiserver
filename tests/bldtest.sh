...
gcc $1.c extgui.c extgui_classes.c ../hbip.c ../listen.c ../misc.c -o$1  -I $HB_INS/include -DHWG_USE_POINTER_ITEM -L $HB_INS/lib/linux/gcc -Wl,--start-group $HARBOUR_LIBS $SYSTEM_LIBS -Wl,--end-group  >bld.log 2>bld.log
